...
from mitgcm_jax.diagnostics.monitor import dynstat, format_dynstat  # noqa: E402
...
def model_date(nml, myTime):
    """data.cal startDate_1/_2 (yyyymmdd, hhmmss) + myTime - startTime (data PARM03: startTime = nIter0*deltaT)."""
    ...
    startTime, _, _ = exf_mod.model_clock(nml)
    return t0 + dt.timedelta(seconds=float(myTime - startTime))
